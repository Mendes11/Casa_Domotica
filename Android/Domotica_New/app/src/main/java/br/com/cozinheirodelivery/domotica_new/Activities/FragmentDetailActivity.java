...
/**
 * An activity representing a single Fragment detail screen. This
 * activity is only used narrow width devices. On tablet-size devices,
 * item details are presented side-by-side with a list of items
 * in a {@link FragmentListActivity}.
 */
public class FragmentDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(FragmentDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(FragmentDetailFragment.ARG_ITEM_ID));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            NavUtils.navigateUpTo(this, new Intent(this, FragmentListActivity.class));
            return true;
        }
