...
class checkPorta{
	...
	function __construct() {
		$this->columNames = array('iIDPorta','cNome','bOpen','bHabilitado','fAutoCloseTime','iIDDeviceStatus');
    }
	...
	# Informa qual o conjunto de caracteres será usado.
		$this->sql = "Select iIDPorta,cNome,bOpen,bHabilitado,fAutoCloseTime,iIDDeviceStatus from Porta";
		$response = array();
