...
class checkPortao{
	...
	function __construct() {
		$this->columNames = array('iIDPortao','cNome','bOpen','bPos','bEnabled','fAutoCloseTime','iIDDeviceStatus');
    }
	...
	# Informa qual o conjunto de caracteres será usado.
		$this->sql = "Select iIDPortao,cNome,bPos,bOpen,bEnabled,fAutoCloseTime,iIDDeviceStatus from Portao";
		$response = array();
